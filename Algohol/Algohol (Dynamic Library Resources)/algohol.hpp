...
{
	template <typename T>
	__declspec(dllexport) T linSearch(T f, T *arr, int n)
	{
		int j=0, found=0;
	...
	template <typename T>
	__declspec(dllexport) T binSearch(T f, T *arr, int n)
	{
...
{
	template <typename T>
	__declspec(dllexport) void bubble(T arr[], int n)
	{
		int temp;
	...
	template <typename T>
	__declspec(dllexport) void bucket(T arr[], int n)
	{
	...
	template <typename T>
	__declspec(dllexport) void insertion(T arr[], int n)
	{
		T temp;
	...
	template <typename T>
	__declspec(dllexport) void merge(T arr[], int n)
	{
		T temp;
	...
	template <typename T>
	__declspec(dllexport) void quick(T arr[], int n, int low=0, int high=NULL, bool flag=false)
	{
	...
	template <typename T>
	__declspec(dllexport) void radix(T arr[], int n)
	{
		int d = 1, arr2[n], arr3[n], flag = 0;
	...
	template <typename T>
	__declspec(dllexport) void selection(T arr[], int n)
	{
		T s; int f,k,temp;
	...
	template <typename T>
	__declspec(dllexport) void shell(T arr[], int n)
	{
		T temp;
